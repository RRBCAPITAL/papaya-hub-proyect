  ...
  return (
    <div className='flex'>
        ...
        <containerall className='flex flex-col items-center  gap-4 min-h-screen w-screen py-[100px] bg-dark-d dark:bg-white'>
          ...
          <div className="text-white dark:text-black p-5 border-bor-light border-4 rounded-lg gap-2">
         ...
         <div className="w-full flex flex-col justify-center items-center text-white dark:text-black p-5 border-bor-light border-4 rounded-lg gap-2">
