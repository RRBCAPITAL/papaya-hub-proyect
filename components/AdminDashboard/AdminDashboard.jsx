...
import { fechaLegible } from "./fechaLegible"
...
const AdminDashboard = ({ arrUsers, currentUserOk }) => {
  ...
  return (
        ...
        <Link href={'/dashboard/videos'} className={`font-bold text-black border-2 border-orange-700 rounded p-2 bg-orange-100 hover:bg-orange-300`}>Videos</Link>
            ...
            <h1 className="font-extrabold text-2xl sm:text-4xl text-center mb-10 py-1 border-b-4 border-bor-red w-fit mx-auto"><strong className="text-t-red">Anuncios</strong> Registrados</h1>
            ...
            <form action="" onSubmit={clickSearch} onKeyUp={handleKeyUp} className="flex justify-center gap-2 my-10">
              ...
              <button type="button" onClick={cleanInput} className="px-4 py-2 rounded-md border-2 border-slate-400 bg-slate-200 font-extrabold hover:bg-slate-100">Todos los anuncios</button>
            </form>
            <div>
      ...
      <table class="min-w-full table-auto mb-20">
        <thead className="border-b-4 border-bor-red rounded-md">
          ...
          <th class="border px-4 py-2  font-extrabold">#</th>
            ...
            <th class="border px-4 py-2  font-extrabold">Referencia</th>
        ...
        <tbody className="">
          ...
          filteredAnuncios ? filteredAnuncios?.map((arr, index) => (
            ...
            <textarea
                ...
                style={{ resize: 'none' }}
                readOnly
                placeholder={arr?.questionEnd}
                className="p-4 text-white placeholder:text-[10px] dark:text-black  focus:text-white focus:dark:text-black border-2 border-bor-red rounded-[10px] outline-none"
