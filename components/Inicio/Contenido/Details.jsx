      ...
      
      {
        ...
        <div className='flex flex-col gap-2 text-medium font-think text-[16px]'>
          ...
          <div className='flex gap-12 font-normal text-sm'>
            <h2>{tarifaPresencial[0]?.value?.length && tarifaPresencial[0]?.name} minutos</h2>
            <h2>S/. {tarifaPresencial[0]?.value?.length && tarifaPresencial[0]?.value}</h2>
          </div>
        </div>
      </div> : ""
      }

      {
        ...
        <div className='flex flex-col text-xl font-bold'>
          ...
          {tarifaVirtual?.filter(tarifa => tarifa.value !== undefined && tarifa.value !== "")
            ?.map(tarifa => <div className='flex gap-12 font-normal text-sm'>
              <h2>{tarifa.name === "60" ? "15" : tarifa.name === "30" ? "10" : tarifa.name === "15" ? "05" : ""} minutos</h2>
              <h2>S/. {tarifa.value}</h2>
            </div>) || ""}
          </div>
        </div>
