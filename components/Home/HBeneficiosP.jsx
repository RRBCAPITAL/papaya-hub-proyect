...
<section className="px-4 py-4 h-full border-l-4 border-bor-red shadow-custom2 dark:shadow-violet-500 shadow-black dark:bg-transparent bg-dark-d dark:text-slate-600 text-slate-100 rounded-[10px] rounded-r-[60px]">
        ...
        <section className="px-4 py-4 h-full border-r-4 border-bor-red  shadow-custom2 dark:shadow-violet-500 shadow-black dark:bg-transparent bg-dark-d dark:text-slate-600 text-slate-100 rounded-[10px]  rounded-l-[60px]">
            <div className="flex gap-2">
