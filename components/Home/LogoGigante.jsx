...
const LogoGigante = () => {
  return (
    <div className={quick.className}>
      <div className='overflow-hidden min-h-fit w-screen dark:bg-white bg-dark-l'>
      ...
      <img src="/assets/phlogo.jpeg" alt="" className="w-[300px] h-fit sm:h-[280px] mx-auto sm:mx-auto sm:w-fit rounded-md shadow-sm"/>
        ...
        <h2 className='mx-auto w-[80%] sm:w-[85%] lg:w-[50%] mt-4 text-2xl sm:text-2xl dark:text-slate-500 text-white text-left sm:text-center'>Contamos con hermosas colombianas, peruanas y venezolanas en Lima Metropolitana, teens +18, y chicas universitarias que ofrecen servicios de forma ocasional, discreta y casual. Están listas y esperando tu mensaje.</h2>
