...
const ReportPage = () => {
  ...
  <div className='flex'>
        ...
        <h1 className='font-bold text-2xl sm:text-[30px] border-b-4 border-bor-red dark:text-white text-black'><strong className='text-t-red '>PapayaHub</strong> - Reporte</h1>
