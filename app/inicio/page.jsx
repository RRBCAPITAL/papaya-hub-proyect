...
<containerall className='flex flex-col items-center  gap-4 min-h-screen w-screen py-20 dark:bg-dark-l bg-white'>
    ...
    {/* <h1 className="my-auto text-red-600 font-bold bg-red-100 p-2 rounded-[20px]">DESCUENTOS por lanzamiento</h1> */}
        <h1 className='mx-auto w-[80%] sm:w-[85%] lg:w-[50%] text-center dark:text-slate-200 text-slate-600 text-3xl sm:text-5xl font-bold border-b-4 pb-2 border-bor-red'>Los mejores planes para tu anuncio</h1>      
        <h2 className='mx-auto w-[80%] sm:w-[85%] lg:w-[50%] mt-4 text-2xl sm:text-2xl text-slate-500 dark:text-white text-left sm:text-center'>En PapayaHub, pensamos en ti. Por eso, creamos planes superpersonalizados y exclusivos adaptados específicamente a tus necesidades. Elige tu plan y descubre una experiencia única con nosotros.</h2> 
