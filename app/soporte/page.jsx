...
const SoportePage = () => {
  ...
  <div className='flex'>
        ...
        <h1 className='font-bold text-2xl sm:text-[30px] border-b-4 border-bor-red text-white dark:text-black'><strong className='text-t-red '>PapayaHub</strong> - Soporte</h1>
